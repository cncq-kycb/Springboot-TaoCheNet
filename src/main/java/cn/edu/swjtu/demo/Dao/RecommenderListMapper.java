...
public interface RecommenderListMapper {
	...
	int updateByExampleSelective(@Param("record") RecommenderList record,
			@Param("example") RecommenderListExample example);

	int updateByExampleWithBLOBs(@Param("record") RecommenderList record,
			@Param("example") RecommenderListExample example);
